# signing_today_client.Bit4idPathgroupOrganizationsApi
...
api_instance = signing_today_client.Bit4idPathgroupOrganizationsApi(signing_today_client.ApiClient(configuration))
