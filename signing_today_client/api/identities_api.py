...
class IdentitiesApi(object):
    ...
    def associate_identity_with_http_info(self, organization_id, user_id, identity_association, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('identity_association' not in local_var_params or  # noqa: E501
                                                        local_var_params['identity_association'] is None):  # noqa: E501
    ...
    def create_token_from_identity_with_http_info(self, organization_id, create_identityby_token, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_identityby_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_identityby_token'] is None):  # noqa: E501
    ...
    def delete_enrollment_request_with_http_info(self, organization_id, enrollment_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('enrollment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['enrollment_id'] is None):  # noqa: E501
    ...
    def get_identity_with_http_info(self, organization_id, identity_id, **kwargs):  # noqa: E501
        ...
        all_params = ['organization_id', 'identity_id', 'where_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_enrollment_requests_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        ...
        all_params = ['organization_id', 'where_provider', 'where_user', 'where_first_name', 'where_last_name', 'where_registered_by', 'where_fiscal_code', 'page', 'count', 'where_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'where_provider' in local_var_params and local_var_params['where_provider'] is not None:  # noqa: E501
        ...
        if 'where_registered_by' in local_var_params and local_var_params['where_registered_by'] is not None:  # noqa: E501
            query_params.append(('where_registered_by', local_var_params['where_registered_by']))  # noqa: E501
        if 'where_fiscal_code' in local_var_params and local_var_params['where_fiscal_code'] is not None:  # noqa: E501
    ...
    def renew_identity(self, organization_id, enrollment_id, inline_object1, **kwargs):  # noqa: E501
        """Renew an Identity  # noqa: E501

        This API allows to renew an Identity of a user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.renew_identity(organization_id, enrollment_id, inline_object1, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.renew_identity_with_http_info(organization_id, enrollment_id, inline_object1, **kwargs)  # noqa: E501

    def renew_identity_with_http_info(self, organization_id, enrollment_id, inline_object1, **kwargs):  # noqa: E501
        """Renew an Identity  # noqa: E501

        This API allows to renew an Identity of a user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.renew_identity_with_http_info(organization_id, enrollment_id, inline_object1, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['organization_id', 'enrollment_id', 'inline_object1']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('organization_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['organization_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `organization_id` when calling `renew_identity`")  # noqa: E501
        # verify the required parameter 'enrollment_id' is set
        if self.api_client.client_side_validation and ('enrollment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['enrollment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `enrollment_id` when calling `renew_identity`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('inline_object1' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `inline_object1` when calling `renew_identity`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{organization-id}/identity-requests/{enrollment-id}/renew', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def request_enrollment_with_http_info(self, organization_id, identity_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('identity_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['identity_request'] is None):  # noqa: E501
