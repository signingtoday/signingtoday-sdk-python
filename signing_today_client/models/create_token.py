...
class CreateToken(object):
    ...
    def __init__(self, http_options=None, label=None, user=None, webhooks=None):  # noqa: E501
        """CreateToken - a model defined in OpenAPI"""  # noqa: E501
    ...
    def http_options(self):
        """Gets the http_options of this CreateToken.  # noqa: E501


        :return: The http_options of this CreateToken.  # noqa: E501
    ...
    def http_options(self, http_options):
        """Sets the http_options of this CreateToken.


        :param http_options: The http_options of this CreateToken.  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this CreateToken.  # noqa: E501

        The label assigned to the Token, that is like the name is associated to it  # noqa: E501

        :return: The label of this CreateToken.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this CreateToken.

        The label assigned to the Token, that is like the name is associated to it  # noqa: E501

        :param label: The label of this CreateToken.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user(self):
        """Gets the user of this CreateToken.  # noqa: E501

        The user whom the Token is to be associated  # noqa: E501

        :return: The user of this CreateToken.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this CreateToken.

        The user whom the Token is to be associated  # noqa: E501

        :param user: The user of this CreateToken.  # noqa: E501
        :type: str
        """
    ...
    @property
    def webhooks(self):
        """Gets the webhooks of this CreateToken.  # noqa: E501


        :return: The webhooks of this CreateToken.  # noqa: E501
    ...
    def webhooks(self, webhooks):
        """Sets the webhooks of this CreateToken.


        :param webhooks: The webhooks of this CreateToken.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateToken):
            return False
