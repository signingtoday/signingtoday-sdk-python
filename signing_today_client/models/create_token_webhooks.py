...
class CreateTokenWebhooks(object):
    ...
    def __init__(self, dst=None, identity=None):  # noqa: E501
        """CreateTokenWebhooks - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def dst(self):
        """Gets the dst of this CreateTokenWebhooks.  # noqa: E501

        The url where to receive notifications about digital signature transaction status  # noqa: E501

        :return: The dst of this CreateTokenWebhooks.  # noqa: E501
        :rtype: str
        """
        return self._dst
    ...
    @dst.setter
    def dst(self, dst):
        """Sets the dst of this CreateTokenWebhooks.

        The url where to receive notifications about digital signature transaction status  # noqa: E501

        :param dst: The dst of this CreateTokenWebhooks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def identity(self):
        """Gets the identity of this CreateTokenWebhooks.  # noqa: E501

        The url where to receive notifications about identity status  # noqa: E501

        :return: The identity of this CreateTokenWebhooks.  # noqa: E501
        :rtype: str
        """
    ...
    def identity(self, identity):
        """Sets the identity of this CreateTokenWebhooks.

        The url where to receive notifications about identity status  # noqa: E501

        :param identity: The identity of this CreateTokenWebhooks.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTokenWebhooks):
            return False
