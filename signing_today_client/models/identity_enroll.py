...
class IdentityEnroll(object):
    ...
    def __init__(self, actions=None, created_by=None, enroll_ticket=None, id=None, label=None, next=None, provider=None, provider_data=None, provider_type=None, registered_by=None, status=None, urlback=None, user=None):  # noqa: E501
