...
class SignatureDST(object):
    ...
    def __init__(self, constraints=None, declinable=None, description=None, display_name=None, profile=None, reason=None, signer=None, urlback=None, where=None):  # noqa: E501
