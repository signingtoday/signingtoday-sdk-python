...
class SignatureImplementationResponse(object):
    ...
    def __init__(self, certificate=None, channel=None, document=None, dst=None, group=None, identity=None, pades_subfilter=None, page=None, position=None, profile=None, provider_id=None, reason=None, signature=None, signature_appearance_uri=None, signature_text=None, signing_time=None, title=None):  # noqa: E501
    ...
    def pades_subfilter(self, pades_subfilter):
        ...
        if pades_subfilter not in allowed_values:
            raise ValueError(
    ...
    def signing_time(self, signing_time):
        ...
        if signing_time not in allowed_values:
            raise ValueError(
