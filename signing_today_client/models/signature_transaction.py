...
class SignatureTransaction(object):
    ...
    def __init__(self, created=None, created_by=None, documents=None, id=None, not_after=None, reason=None, status=None, template_name=None, title=None, urlback=None):  # noqa: E501
