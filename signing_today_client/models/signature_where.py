...
class SignatureWhere(object):
    ...
    def __init__(self, page=None, position=None, image_uri=None, text=None, local_vars_configuration=None):  # noqa: E501
        """SignatureWhere - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def page(self):
        """Gets the page of this SignatureWhere.  # noqa: E501

        As can be guessed this is the page where to allocate the Signature  # noqa: E501

        :return: The page of this SignatureWhere.  # noqa: E501
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        """Sets the page of this SignatureWhere.

        As can be guessed this is the page where to allocate the Signature  # noqa: E501

        :param page: The page of this SignatureWhere.  # noqa: E501
        :type: int
        """
    ...
    @property
    def position(self):
        """Gets the position of this SignatureWhere.  # noqa: E501
        ...
        :return: The position of this SignatureWhere.  # noqa: E501
        :rtype: str
        """
    ...
    def position(self, position):
        """Sets the position of this SignatureWhere.

        This is the exact position in the choosen page where to attach the Signature. Multiple unit of measurement are provided. The format is the following: \"rect: 50mm, 100mm, 200mm, 150mm\"   # noqa: E501

        :param position: The position of this SignatureWhere.  # noqa: E501
        :type: str
        """
    ...
    @property
    def image_uri(self):
        """Gets the image_uri of this SignatureWhere.  # noqa: E501
        ...
        :return: The image_uri of this SignatureWhere.  # noqa: E501
        :rtype: str
        """
    ...
    def image_uri(self, image_uri):
        """Sets the image_uri of this SignatureWhere.

        If provided this current image will be used for the signature, as a graphic appearance. This overrides the appearance definited in the Identity, which still will be the default one. If no signature appearance is provided in the Identity than will be used the default one of the Organization. If you choose to avoi the signature appearance than use this field as follows: _image_uri_: null   # noqa: E501

        :param image_uri: The image_uri of this SignatureWhere.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this SignatureWhere.  # noqa: E501
        ...
        :return: The text of this SignatureWhere.  # noqa: E501
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this SignatureWhere.

        The text field will be filled with a list of paragraphs that will be displayed next to the graphic signature. Each paragraph may have its own font type, font dimension, line-up and a list of rows (strings) which will compose the paragraph. It is possible to specify some _placeholders_ as well. The paragraph objects will use default font and line-up if none was specified. If no **format** field is specified than will be used the default one:   \"format\": [     \"Signed by {subject[commonName]}\",     \"{subject[C]}\",     \"{subject[L]}\",     \"{subject[S]}\",     \"{subject[OU]}\",     \"{subject[O]}\",     \"{subject[E]}\"   ] Where {subject[...]} is a placeholder which will be filled with the certificate attirbutes. Follows the list of the placeholders:   - commonName: CommonName   - OU: OrganizationalUnit   - O: Organization   - L: Locality   - S: StateOrProvinceName   - C: CountryName   # noqa: E501

        :param text: The text of this SignatureWhere.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignatureWhere):
            return False
