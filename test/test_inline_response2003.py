...
from signing_today_client.models.inline_response2003 import InlineResponse2003  # noqa: E501
...
class TestInlineResponse2003(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = signing_today_client.models.inline_response2003.InlineResponse2003()  # noqa: E501
        if include_optional :
            return InlineResponse2003(
                ...
                meta = signing_today_client.models.meta_success.Meta success(
                    code = 200, ), 
                data = [
                    signing_today_client.models.identity_enroll.Identity enroll(
                        id = '737dc132-a3f0-11e9-a2a3-2a2ae2dbcce4', 
                        status = 'active', 
                        next = 'next activity to complete sample', 
                        actions = signing_today_client.models.identity_enroll_actions.IdentityEnroll_actions(
