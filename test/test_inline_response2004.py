...
from signing_today_client.models.inline_response2004 import InlineResponse2004  # noqa: E501
...
class TestInlineResponse2004(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = signing_today_client.models.inline_response2004.InlineResponse2004()  # noqa: E501
        if include_optional :
            return InlineResponse2004(
                pagination = signing_today_client.models.pagination.Pagination(
                    count = 2, 
                ...
                meta = signing_today_client.models.meta_success.Meta success(
                    code = 200, ), 
                data = [
                    signing_today_client.models.token.Token(
                        id = '737dc132-a3f0-11e9-a2a3-2a2ae2dbcce4', 
                        value = '8df173c3bcd4274715491fc196705da8', 
                        user = 'jdo', 
                        webhooks = signing_today_client.models.token_webhooks.Token_webhooks(
                            identity = 'https://host-name/identity', 
                            dst = 'https://host-name/dst', ), 
                        http_options = signing_today_client.models.token_http_options.Token_http_options(
