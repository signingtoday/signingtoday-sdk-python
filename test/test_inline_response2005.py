...
from signing_today_client.models.inline_response2005 import InlineResponse2005  # noqa: E501
...
class TestInlineResponse2005(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = signing_today_client.models.inline_response2005.InlineResponse2005()  # noqa: E501
        if include_optional :
            return InlineResponse2005(
                ...
                meta = signing_today_client.models.meta_success.Meta success(
                    code = 200, ), 
                data = signing_today_client.models.identity.Identity(
                    id = '737dc132-a3f0-11e9-a2a3-2a2ae2dbcce4', 
                    certificate = '<certificate-string>', 
                    not_after = '2021-10-17T07:26Z', 
                    status = 'active', 
                    next = 'next activity to complete <sample>', 
                    actions = signing_today_client.models.identity_actions.Identity_actions(
